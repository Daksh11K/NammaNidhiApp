...
class AppStateNotifier extends ChangeNotifier {
  ...
  NammaNidhiAuthUser? initialUser;
  NammaNidhiAuthUser? user;
  ...
  void update(NammaNidhiAuthUser newUser) {
    final shouldUpdate =
...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'AdditionalInfo',
          path: '/additionalInfo',
          builder: (context, params) => const AdditionalInfoWidget(),
        ),
        FFRoute(
          name: 'BusinessInfo',
          path: '/businessInfo',
        ...
        FFRoute(
          name: 'FinancialInfo',
          path: '/financialInfo',
          builder: (context, params) => const FinancialInfoWidget(),
        ),
        FFRoute(
          name: 'LoanInfo',
          path: '/loanInfo',
          builder: (context, params) => const LoanInfoWidget(),
        )
