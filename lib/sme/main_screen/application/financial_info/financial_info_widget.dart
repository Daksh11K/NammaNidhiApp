...
class FinancialInfoWidget extends StatefulWidget {
  const FinancialInfoWidget({super.key});
...
class _FinancialInfoWidgetState extends State<FinancialInfoWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FinancialInfoModel());

    _model.uanTextController1 ??= TextEditingController();
    _model.uanFocusNode1 ??= FocusNode();
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: TextFormField(
                      controller: _model.uanTextController1,
                      focusNode: _model.uanFocusNode1,
                      autofocus: true,
                      obscureText: false,
                  ...
                  Padding(
                    padding: const EdgeInsetsDirectional.fromSTEB(8.0, 0.0, 8.0, 0.0),
                    child: TextFormField(
                      controller: _model.uanTextController2,
                      focusNode: _model.uanFocusNode2,
                      autofocus: true,
                      obscureText: false,
                      decoration: InputDecoration(
